...
export function RobotForm(robot) {
  ...
  return (
    <>
        ...
        <div>
          <label htmlFor="name">
            ...
            <input
              ...
              id="name"
              name="name"
              placeholder={currentRobot.name ? currentRobot.name : ""}
              maxLength="30"
        ...
        <div>
          <label htmlFor="image">
            ...
            <input
              ...
              id="image"
              name="image"
              placeholder={currentRobot.image ? currentRobot.image : ""}
              onChange={(ev) => handleChange(ev)}
            ></input>
            {pathname[2] === "update" ? (
        ...
        <div>
          <label htmlFor="strength">
            ...
            <input
              ...
              id="strength"
              name="strength"
              placeholder={currentRobot.strength ? currentRobot.strength : ""}
              min="0"
              max="10"
              maxLength="2"
              onChange={(ev) => handleChange(ev)}
        ...
        <div>
          <label htmlFor="speed">
            ...
            <input
              ...
              id="speed"
              name="speed"
              placeholder={currentRobot.speed ? currentRobot.speed : ""}
              min="0"
              max="5"
              maxLength="1"
              onChange={(ev) => handleChange(ev)}
        ...
        <div>
          <label htmlFor="creationdate">
            ...
            <input
              ...
              id="creationdate"
              name="creationdate"
              placeholder={currentRobot.creationdate ? currentRobot.creationdate : ""}
              min="1939"
              max="2022"
              maxLength="4"
              onChange={(ev) => handleChange(ev)}
      ...
      <Link to={`/robots/${currentRobot._id}`}>
        {pathname[2] === "update" ? <button>Volver a detalles de {currentRobot.name}</button> : ""}
      </Link>
      <Link to="/robots">
